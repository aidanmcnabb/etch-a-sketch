...
if (mobileAndTabletCheck()) {
    ...
    onlyDesktop.classList.add('animation-container3')
    onlyDesktop.textContent = 'This is strictly a desktop application. Sorry.'
    document.body.appendChild(onlyDesktop)
} else {
    if (intro === false) {
        introAndTutorial()
    } else {
